import type { PlanTriplexOptions, PlanBuilder } from '../types.js';
...
function generateProvidersModule(builder: PlanBuilder): string {
...
export function planTriplex(builder: PlanBuilder, options: PlanTriplexOptions | undefined) {
    if (options == null) {
        return;
    }
