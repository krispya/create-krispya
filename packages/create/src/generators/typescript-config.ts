 ...
 * In standalone context: solution-style tsconfig with separate app and node configs in .config/.
 */
export function generateTypescriptConfig(
  ...
  // Standalone context - solution-style tsconfig with .config/ folder
  const tsConfig = {
    $schema: "https://json.schemastore.org/tsconfig",
    files: [],
